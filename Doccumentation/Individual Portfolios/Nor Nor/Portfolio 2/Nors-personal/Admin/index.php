	...
	<nav class="nav-main">
		...
		<ul>
			...
			<li><input type="radio" name="nav-group" id="mega" class="nav-option">
				<label for="mega" class="nav-item"><?php if ($username=='admin1') { ?>ADMIN<?php } else { ?>FIND OUT MORE<?php } ?></label> <label
				for="nav-close" class="nav-close"> </label>

				<div class="nav-content">
					<div class="nav-sub">
						<a
							href="http://localhost/ifb299-project/Project%20Files/searchresult.php">MANAGE PROPERTIES</a>
					</div>
				</div></li>
